...
public class ThreadedServer 
{
	...
	public static void main(String args[]) {
        ...
        try 
        {
            ...
            //Ascii art designed with http://patorjk.com/software/taag/#p=display&f=Big&t=Fruity%20Manager
            System.out.println("  ______          _ _           __  __                                   \r\n" + 
            		" |  ____|        (_) |         |  \\/  |                                  \r\n" + 
            		" | |__ _ __ _   _ _| |_ _   _  | \\  / | __ _ _ __   __ _  __ _  ___ _ __ \r\n" + 
            		" |  __| '__| | | | | __| | | | | |\\/| |/ _` | '_ \\ / _` |/ _` |/ _ \\ '__|\r\n" + 
            		" | |  | |  | |_| | | |_| |_| | | |  | | (_| | | | | (_| | (_| |  __/ |   \r\n" + 
            		" |_|  |_|   \\__,_|_|\\__|\\__, | |_|  |_|\\__,_|_| |_|\\__,_|\\__, |\\___|_|   \r\n" + 
            		"                         __/ |                            __/ |          \r\n" + 
            		"                        |___/                            |___/   \nThe server has started listening on port: " + portNumber );
        } 
        catch (IOException e) 
        {
